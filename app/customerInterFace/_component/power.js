...
const Power = () => {
    ...
    console.log(lang?.[state.lang.value]?.powerDetails?.['title'])
    return (
        <>
            <Fade duration={2000}>
                <div className='rounded-[20px]'>
                    ...
                    <h3 className=' font-semibold p-6 text-3xl'>{lang?.[state.lang.value]?.powerDetails?.['title']}</h3>
                    {/* </div>
                        </div> */}  

                        <div className='flex'>
                            <div className='w-[85px] border-[1px] flex justify-center items-center px-4 py-2  font-semibold'>Eye</div>
                            <div className='w-[85px] border-[1px] flex justify-center items-center px-4 py-2 font-semibold'>sphere</div>
                            <div className='w-[85px] border-[1px] flex justify-center items-center px-4 py-2 font-semibold'>Cylinder</div>
                            <div className='w-[85px] border p-3 outline-none flex justify-center items-center px-4 py-2 font-semibold'>Axis</div>
                            <div className='w-[85px] border-[1px] flex justify-center items-center px-4 py-2 font-semibold'>Add</div>
                        </div>

                        <div className='flex'>
                            <div className='w-[85px] border-[1px] flex justify-center items-center px-4 py-2 font-semibold'>
                                Right
                            </div>
                            <div className={`w-[85px]  flex justify-center items-center ${state.rs.error ? "border border-red-700" : 'border'}`}>
                  ...
                  className=    {`w-full px-4 py-2     placeholder:text-xs   hover:bg-[#f1f5f9] focus:bg-[#f1f5f9]
                            ...
                            <div className='w-[85px] border flex justify-center items-center'>
                  ...
                  className='w-full px-4 py-2    placeholder:text-xs placeholder:text-gray-400  hover:bg-[#f1f5f9] focus:bg-[#f1f5f9]
                            ...
                            <input 
                                type='number'
                                className='w-[85px] border flex justify-center items-center p-3 outline-none'
                                />
                            </div>
                  ...
                  className='w-full px-4 py-2    placeholder:text-xs placeholder:text-gray-400  hover:bg-[#f1f5f9] focus:bg-[#f1f5f9]
                        ...
                        <div className='flex'>
                            ...
                            <div className={`w-[85px]  flex justify-center items-center ${state.ls.error ? "border border-red-700" : 'border'}`}>
